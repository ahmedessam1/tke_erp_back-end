...
Route::middleware(['auth:api', 'tenant'])->group(function () {
    Route::prefix('requirements')->name('requirements.')->group(function () {
        ...
        // GET PRODUCT DISMISS REASONS
        Route::get('/expenses_types', 'RequirementsController@expensesTypes')
            ->name('expenses_types');

        // GET INVOICE NUMBER BASED ON INVOICE TYPE
        Route::get('/invoice_number/{invoice_type}', 'RequirementsController@invoiceNumberGenerator')
            ->name('invoice_number');
    });
});
